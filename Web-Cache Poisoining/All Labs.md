...
Now we send the request to root / endpoint with a variable and a value for cache busting
...
Now I change the value of cb variable we see it will appear in response with different cache busting value I mean different origin header value
...
And in response we have query parameter and a  value
